...
public abstract class VFS {
	...
	/**
	 * Get the singleton {@link VFS} instance. If no {@link VFS} implementation can
	 * be found for the current environment, then this method returns null.
	 */
	...
	/**
	 * Adds the specified class to the list of {@link VFS} implementations. Classes
	 * added in this manner are tried in the order they are added and before any of
	 * the built-in implementations.
	 * 
...
//	      return ReflectUtil.findClass(className);
	...
	/**
	 * Get a list of {@link URL}s from the context classloader for all the resources
