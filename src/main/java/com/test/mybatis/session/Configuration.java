...
import com.test.mybatis.binding.MapperRegistry;
import com.test.mybatis.builder.CacheRefResolver;
import com.test.mybatis.builder.IncompleteElementException;
import com.test.mybatis.builder.ResultMapResolver;
import com.test.mybatis.builder.annotation.MethodResolver;
import com.test.mybatis.builder.xml.XMLStatementBuilder;
import com.test.mybatis.cache.Cache;
import com.test.mybatis.cache.decorators.FifoCache;
import com.test.mybatis.cache.decorators.LruCache;
import com.test.mybatis.cache.decorators.SoftCache;
import com.test.mybatis.cache.decorators.WeakCache;
import com.test.mybatis.cache.impl.PerpetualCache;
import com.test.mybatis.datasource.jndi.JndiDataSourceFactory;
import com.test.mybatis.datasource.pooled.PooledDataSourceFactory;
import com.test.mybatis.datasource.unpooled.UnpooledDataSourceFactory;
import com.test.mybatis.executor.BatchExecutor;
import com.test.mybatis.executor.CachingExecutor;
import com.test.mybatis.executor.Executor;
import com.test.mybatis.executor.ReuseExecutor;
...
import com.test.mybatis.executor.loader.cglib.CglibProxyFactory;
import com.test.mybatis.executor.loader.javassist.JavassistProxyFactory;
import com.test.mybatis.executor.parameter.ParameterHandler;
import com.test.mybatis.executor.resultset.DefaultResultSetHandler;
...
import com.test.mybatis.logging.commons.JakartaCommonsLoggingImpl;
import com.test.mybatis.logging.jdk14.Jdk14LoggingImpl;
import com.test.mybatis.logging.log4j.Log4jImpl;
import com.test.mybatis.logging.log4j2.Log4j2Impl;
import com.test.mybatis.logging.nologging.NoLoggingImpl;
import com.test.mybatis.logging.slf4j.Slf4jImpl;
import com.test.mybatis.logging.stdout.StdOutImpl;
...
import com.test.mybatis.scripting.LanguageDriverRegistry;
import com.test.mybatis.scripting.defaults.RawLanguageDriver;
import com.test.mybatis.scripting.xmltags.XMLLanguageDriver;
import com.test.mybatis.transaction.Transaction;
import com.test.mybatis.transaction.jdbc.JdbcTransactionFactory;
import com.test.mybatis.transaction.managed.ManagedTransactionFactory;
import com.test.mybatis.type.JdbcType;
import com.test.mybatis.type.TypeAliasRegistry;
...
public class Configuration {
	...
	//MapperRegistry的功能就是注册和获取Mapper对象的代理。
	...
	public Configuration() {
		System.out.println("初始化 Configuration...");
		System.out.println("注册系统别名...");
		...
		System.out.println("注册别名之后...");
		System.out.println(typeAliasRegistry.getTypeAliases().toString());
	}
