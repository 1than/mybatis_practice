...
public class UnknownTypeHandler extends BaseTypeHandler<Object> {
	...
	// TODO Rename to 'configuration' after removing the 'configuration'
	// property(deprecated property) on parent class
	 ...
	 * @deprecated Since 3.5.4, please use the
	 *             {@link #UnknownTypeHandler(Configuration)}.
	 */
	@Deprecated
