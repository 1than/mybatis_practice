...
public class ArrayUtil {
	 ...
	 *
	 * @param obj The object to get a hash code for. May be an array or
	 *            <code>null</code>.
	 ...
	 * <li>{@code thisObj} and {@code thatObj} are arrays with the same component
	 * type and equals() method of {@link Arrays} returns <code>true</code> (not
	 * deepEquals())</li>
	 * </ul>
	 *
	 * @param thisObj The left hand object to compare. May be an array or
	 *                <code>null</code>
	 * @param thatObj The right hand object to compare. May be an array or
	 *                <code>null</code>
	 * @return <code>true</code> if two objects are equal; <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * If the {@code obj} is an array, toString() method of {@link Arrays} is
	 * called. Otherwise {@link Object#toString()} is called. Returns "null" if
	 * {@code obj} is <code>null</code>.
	 *
